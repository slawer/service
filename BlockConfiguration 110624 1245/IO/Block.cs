...
namespace BlockConfiguration.IO
{
    ...
    public class Block
    {
        ...
        /// <summary>
        /// определяет номера переключаемых индикаторов
        /// </summary>
        public byte NumbersOfIndicators
        {
            get { return numbertOfPerecl; }
            set { numbertOfPerecl = value; }
        }

        /// <summary>
        /// Возвращяет номер первого переключаемого индикатора
        /// </summary>
        public byte Perecl1
        {
            get { return (byte)(this.numbertOfPerecl >> 4); }
        }

        /// <summary>
        /// Возвращяет номер второго переключаемого индикатора
        /// </summary>
        public byte Perecl2
        {
            get { return (byte)(this.numbertOfPerecl & 15); }
        }
