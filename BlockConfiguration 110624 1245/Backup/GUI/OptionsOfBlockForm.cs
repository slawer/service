...
namespace BlockConfiguration.GUI
{
    public partial class OptionsOfBlockForm : Form
    {
        ...
        private void Accept_Click(object sender, EventArgs e)
        {
            ...
            {
                case "38400": block.Speed = 0x00; break;
                case "57600": block.Speed = 0x05; break;
                default: block.Speed = 0x00; break;
            }

            switch (comboBoxTypeCRC.Text)
            {
                case "CRC16(два байта)": block.TypeCRC = 0xCC; break;
                case "Однобайтовая по модулю 255": block.TypeCRC = 0x00; break;
                default: block.TypeCRC = 0x00; break;
            }
