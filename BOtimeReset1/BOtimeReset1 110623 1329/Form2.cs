...
namespace BOtimeReset1
{
    ...
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                j1 = int.Parse(textBox1.Text); 
                j2 = int.Parse(textBox2.Text); 
                j3 = int.Parse(textBox3.Text); 
                j4 = int.Parse(textBox4.Text); 
                j5 = int.Parse(textBox5.Text); 
                j6 = int.Parse(textBox6.Text); 
                j7 = int.Parse(textBox7.Text); 
            }

            catch
            {
                MessageBox.Show("Не верно задан адрес БО");
                return;
            };
